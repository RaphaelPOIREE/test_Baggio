...
usepackage[noRaccourci]{Raf_Notations_Torseurs}
	...
	\begin{tabular}{|p{0.35\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
		...
		\\\hline\hline
			\verb!\T!			&	\T			&	Symbole ``T'' de torseur \rac
		\\\hline
			\verb!\torseur{X}!		&	\torseur{X}		&	Objet torseur
		\\\hline
			\verb!\tT!			&	\tT			&	Torseur \T \rac
		\\\hline
	...
	\begin{tabular}{|p{0.35\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
		...
		\\\hline
			\verb!\resultante{\T}!		&	\resultante{\T}		&	Résultante (de \T)
		\\\hline
			\verb!\resultante{1}[2]!	&	\resultante{1}[2]		&	Résultante d'un objet par rapport à un autre
		\\\hline
			\verb!\moment{A}{\T}!		&	\moment{A}{\T}		&	Moment de \T au point $A$
		\\\hline
	...
	\begin{tabular}{|p{0.35\linewidth}|p{0.3\linewidth}|p{0.3\linewidth}|}
		\hline
			\textbf{Commandes}&\textbf{Rendus}&\textbf{Commentaires}
		\\\hline\hline
			\verb!\automoment{\T}!		&	\automoment{\T}	&	Automoment
		\\\hline
			\verb!\automoment{1}[2]!	&	\automoment{1}[2]	&	Automoment
		\\\hline
			\verb!\axeCentral{\T}!	&	\axeCentral{\T}	&	Axe Central du torseur
		\\\hline
			\verb!\axeCentral{1}[2]!	&	\axeCentral{1}[2]	&	Axe Central du torseur
		\\\hline
			\verb!\comoment{\T_1}{\T_2}!	&	\comoment{\T_1}{\T_2}	&	Comoment de deux torseurs
		\\\hline
			\verb!\devComoment{A}{\T_1}! \verb!{\T_2}!	&	\devComoment{A}{\T_1}{\T_2}	&	Comoment en développant avec les éléments de réduction
		\\\hline
	\end{tabular}
