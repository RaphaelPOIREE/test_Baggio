...
\begin{document}
	...
	%-----------------------------
		...
		\begin{itemize}
			\item \href{http://www.ctan.org/pkg/bclogo}{\textbf{bclogo}} : pour faire de jolies boîtes (ce package appelle Tikz).
			\item \href{http://ctan.org/pkg/graphicx}{\textbf{graphicx}} : Permet notamment de faire des logos personnalisés
			\item \href{http://ctan.org/pkg/graphicx}{\textbf{xcolor}} : Permet la gestion des couleurs.
		\end{itemize}
